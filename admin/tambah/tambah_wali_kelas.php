                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Tambah Wali Kelas</h2>
                            
                                <div class="form-group marx">
                                <form action="" method="post">
                                <label for="">Id Wali Kelas</label>
                                <input type="text" class="form-control buleud" name="id_wali_kelas">

                                    <label>Nama Wali Kelas</label>
                                    <input type="text" class="form-control buleud" name="nm_wali_kelas">                                     

                                    <label>Kelas</label>
                                    <input type="text" class="form-control buleud" name="Kelas">                                     
