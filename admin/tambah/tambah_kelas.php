                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Tambah kelas</h2>
                                ...
                                <select class="form-control buleud" name="id_user">
                                  ...
                                  <?php endforeach; ?>
                                    ...
                                    <input type="text" class="form-control buleud" name="nm_kelas">
                                    

                                    <label>id kelas</label>
                                    <input type="text" class="form-control buleud" name="id_kelas">
                                    ...
                                    <input type="text" class="form-control buleud" name="jumlah_siswa" >
