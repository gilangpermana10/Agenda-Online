                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Tambah Mata Pelajaran</h2>
                            
                                <div class="form-group marx">
                                <form action="" method="post">
                                <label for="">Id Mata Pelajaran</label>
                                <input type="text" class="form-control buleud" name="id_mapel">

                                    <label>Nama Mapel</label>
                                    <input type="text" class="form-control buleud" name="nm_mapel" >
