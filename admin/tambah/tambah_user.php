                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Tambah Siswa</h2>
                            
                                <div class="form-group marx">
                                  <form action="" method="post">
                                    <label>Username</label>
                                    <input type="text" class="form-control buleud" name="Username" id="Username" >
                                    

                                    <label>Password</label>
                                    <input type="text" class="form-control buleud" name="password" id="password" >
                                    ...
                                    <label>Id User</label>
                                    <input type="text" class="form-control buleud" name="id_user" id="id_user">
                                     

                                    <a href="../user.php" class="btn btn-danger buleud mt"><i class="fa fa-arrow-left"></i> kembali</a>
                                    <button class="btn btn-success buleud mt" type="submit" name="submit"><i class="fa fa-save"></i> Tambah</button>
                                    </form>
                                </div>
                                </div>
