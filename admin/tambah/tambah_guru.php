                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Tambah Guru</h2>
                            
                                <div class="form-group marx">
                                <form action="" method="post">
                                <label for="">Id Guru</label>
                                <input type="text" class="form-control buleud" name="id_guru">
                                
                                    <label>Nama Guru</label>
                                    <input type="text" class="form-control buleud" name="nm_guru" >
                                     
                                    <a href="guru.php" class="btn btn-danger buleud mt"><i class="fa fa-arrow-left"></i> kembali</a>
