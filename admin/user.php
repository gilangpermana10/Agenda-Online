<?php
            ...
            <div class="col-lg-12 ">
                    <div class="control-group">
                            ...
                            <form method="post" action="">
                              ...
                              <input class="form btn buleud" type="text" id="keyword" name="keyword" autocomplete="off" placeholder="masukan keyword">
                              <button class="form btn btn-info buleud" type="submit" id="cariuser" name="cari"><i class="fa fa-search"></i> CARI </button>
                            </form>
                            </div>
                    </div>
                    </div>
        ...
        <div class="row" >
          <div class="col-sm-12">
          <h2 class="dispay-2  text-left">Daftar User</h2>
          <div id="containertab">
          <table class="table  table-advance table-hover">
              ...
              <a href="tambah/tambah_user.php"><button class="btn btn-success buleud"><i class="fa fa-plus"></i>Tambah</button></a>
              <a href="cetak/cetak_user.php"><button class="btn btn-info buleud" type="submit"><i class="fa fa-print"></i> PRINT</button></a>
          </div>
