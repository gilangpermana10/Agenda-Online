<?php
        ...
        include 'cari/cari_wali_kelas.php';
         
        $wali_kelas=query("SELECT * FROM tb_wali_kelas");

        if(isset($_POST["cari"])){
          $wali_kelas = cari($_POST["keyword"]);
        }
          ...
          <head>
            ...
            <script src="js/wali_kelas.js"></script>
...
<div class="col-lg-12 ">
        <div class="control-group">
                ...
                <label>Cari Wali Kelas </label>
                  <input class="form  btn buleud" type="text" name="keyword" id="keyword"autocomplete="off">
                  <button class="form btn btn-info buleud" id="cari" type="submit" name="cari"><i class="fa fa-search"></i> CARI </button>
                </form>
                </div>
        </div>
        </div>
...
<div class="row">
<div class="col-sm-12">
<h2 class="dispay-2  text-left">Daftar Wali Kelas</h2>
<div id="containertab">
<table class="table  table-advance table-hover">
    ...
    <tr>
        ...
        <td><?= $row["kelas"]; ?></td>
        <td>
          <a href="update/update_wali_kelas.php?wali_kelas=<?= $row["id_wali_kelas"]; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
  ...
  <a href="tambah/tambah_wali_kelas.php"><button class="btn btn-success buleud"><i class="fa fa-plus"></i>Tambah</button></a>
