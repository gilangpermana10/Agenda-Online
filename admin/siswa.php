...
<div class="row">
<div class="col-sm-12">
<h2 class="dispay-2  text-left">Daftar siswa</h2>
<div id="containertab">
<table class="table  table-advance table-hover">
  ...
  <a href="tambah/tambah_siswa.php"><button class="btn btn-success buleud"><i class="fa fa-plus"></i>Tambah</button></a>
