...
require 'functions/function_mapel.php';
require '../koneksi.php';

$mapel = $_GET["mapel"];

// query data mahasiswa berdasarkan id
$mapel = query("SELECT * FROM tb_mapel WHERE id_mapel = $mapel")[0];
                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Edit Data Mata Pelajaran</h2>
                            
                                <div class="form-group marx">
                                <form action="" method="post">
                                
                                <input type="hidden" class="form-control buleud" name="id_mapel" value="<?= $mapel["id_mapel"]; ?>">

                                    <label>Nama Mapel</label>
                                    <input type="text" class="form-control buleud" name="nm_mapel" value="<?= $mapel["nm_mapel"]; ?>" >
                                     
                                    <a href="../mapel.php" class="btn btn-danger buleud mt"><i class="fa fa-arrow-left"></i> kembali</a>
