...
require 'functions/function_guru.php';
require '../koneksi.php';

$id_guru = $_GET["guru"];

// query data mahasiswa berdasarkan id
$guru = query("SELECT * FROM tb_guru WHERE id_guru = $id_guru")[0];
                ...
                <section class="wrapper turun text-center">
                    ...
                    <div class="row buleud justify-content-center">
                        ...
                        <div class="form-panel buleud">
                            <h2 class="display-2  text-center">Edit data Guru</h2>
                                ...
                                <input type="hidden" name="id_guru" value="<?= $guru["id_guru"]; ?>">
                                    ...
                                    <input type="text" class="form-control buleud" name="nm_guru" value="<?= $guru["nm_guru"]; ?>" >
                                     
                                    <a href="../guru.php" class="btn btn-danger buleud mt"><i class="fa fa-arrow-left" onclick="return confirm ('yakin?')"></i> kembali</a>
